"""
Migration 0013 — انتقال بین شعب و ضایعات
...
نکته مهم درباره DamageRegistration:
  این migration داده‌های DamageRegistration را حذف نمی‌کند.
  جداول قدیمی در دیتابیس باقی می‌مانند اما endpoint های آن‌ها
  از urls.py حذف خواهند شد. حذف فیزیکی جداول در صورت نیاز
  با یک migration جداگانه انجام می‌شود.
"""
import uuid
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rejection_reason', models.TextField(
                    ...
                    verbose_name='دلیل عدم تایید',
                )),
                ('sender_note', models.TextField(
                    blank=True, null=True,
                    verbose_name='توضیحات فرستنده هنگام تایید',
                )),
                ('receiver_note', models.TextField(
                    blank=True, null=True,
                    verbose_name='توضیحات گیرنده هنگام تایید',
                )),
